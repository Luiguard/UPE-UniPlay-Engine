import { EntityState, CorrectionResult, Vec3 } from '@uniplay/core';

export class VisualSmoothing {
  
  // We keep track of the rendering position of entities vs their logical position
  private renderPositions: Map<string, Vec3> = new Map();

  public updateRenderPosition(entityId: string, logicalTarget: Vec3, correction: CorrectionResult | null, deltaTime: number): Vec3 {
